...
var _mediaFeatureColonSpaceChecker = _interopRequireDefault(require("../mediaFeatureColonSpaceChecker"));
        ...
        for (_iterator.s(); !(_step = _iterator.n()).done;) {
          ...
          try {
            for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
              ...
              var beforeColon = params.slice(0, index + 1);
              var afterColon = params.slice(index + 1);
              if (primary === "always") {
