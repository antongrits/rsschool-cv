...
function ruleMessages(ruleName, messages) {
  ...
  var _loop = function _loop() {
    var _Object$entries$_i = _slicedToArray(_Object$entries[_i], 2),
      messageId = _Object$entries$_i[0],
      messageText = _Object$entries$_i[1];
    if (_typeof(messageText) === "string") {
      newMessages[messageId] = "".concat(messageText, " (").concat(ruleName, ")");
    } else {
      newMessages[messageId] = function () {
        return "".concat(messageText.apply(void 0, arguments), " (").concat(ruleName, ")");
      };
    }
  };
